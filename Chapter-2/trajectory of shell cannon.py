# -*- coding: utf-8 -*-
"""
Created on Sun May 08 17:29:01 2016
...
pl.xlim(0,40000)
pl.ylim(0,20000)
pl.xlabel('x:range(m)',fontsize=18)
pl.ylabel('y:altitude(m)',fontsize=18)
comp= PROJECTILE(x0, y0, v0, np.pi/4, B_m, a, alpha, T0, g, 0.5)
comp.calculate()
comp.plot()
pl.annotate(r'$v_{0}$'+'= '+'1000.00 m/s',
            xy=(1000,13000), fontsize=25
            )            

# plot the motion with diffrent dt
# where:    theta0= pi/4 rad,   v0= 1000m/s,   dt= 20, 10, 5, 0.5, 0.1s
pl.subplot(132)
pl.xlim(0,40000)
pl.ylim(0,20000)
pl.xlabel('x:range(m)',fontsize=18)
...
# where:    theta0= pi/4 rad,   v0= 1000m/s,   dt= 0.5s
pl.subplot(133)
x,v,theta= [], [], []

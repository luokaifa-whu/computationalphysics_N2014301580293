# -*- coding: utf-8 -*-
"""
Created on Tue Jun 14 13:38:21 2016
...
ax4.set_xlabel(r'$x$'+' (AU)',fontsize=18)
ax4.set_ylabel(r'$y$'+' (AU)',fontsize=18)
ax1.set_title(r'$\beta=3.00$'+'  '+r'$e=0$',fontsize=18)
ax2.set_title(r'$\beta=3.00$'+'  '+r'$e=0.15$',fontsize=18)
ax3.set_title(r'$\beta=3.00$'+'  '+r'$e=0.40$',fontsize=18)
ax4.set_title(r'$\beta=3.00$'+'  '+r'$e=0.80$',fontsize=18)

cmp=INVERSE(3.00,0)
cmp.cal()
cmp.plot_trajectory(ax1,'y')
...
cmp=INVERSE(3.00,0.15)
cmp.cal()
cmp.plot_trajectory(ax2,'y')
...
cmp=INVERSE(3.00,0.80)
cmp.cal()
cmp.plot_trajectory(ax4,'y')
